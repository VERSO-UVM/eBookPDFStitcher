    ...
    while True:
        ...
        if event == "Delete Pages":
            ...
            if save_pages:
                ...
                pdfe.save_remaining_pages(pdf_file, remaining_pdf, save_pages)
...
def main():
   ...
   # Create a temporary directory in the output folder and define the path for the merged PDF file
    ...
    pdfe.merge_pdfs(pdf_files, merged_pdf)
    ...
    pdfe.renumber_pdf(merged_pdf, renumbered_pdf)
    ...
    pdfe.delete_pages(renumbered_pdf, pages_to_delete, final_output_pdf)
